...
namespace nahodne_mena
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            Random r = new Random();
            Console.WriteLine("Female full name: ");

            string WfullName = GetRandomString(femaleFirstNames, r) + " " + GetRandomString(femaleSurnamesSk, r);
            Console.WriteLine(WfullName);


            Console.WriteLine("Male full name: ");
            string MfullName = GetRandomString(maleFirstNames, r) + " " + GetRandomString(maleSurnamesSk, r);
            Console.WriteLine(MfullName);
